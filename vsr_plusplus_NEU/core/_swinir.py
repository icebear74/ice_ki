...
# Adapted for ice_ki: timm dependency replaced with inline implementations.
# -----------------------------------------------------------------------------------
...
# ── timm replacements (DropPath, to_2tuple) ──────────────────────────────────
...
class DropPath(nn.Module):
    """Drop paths (Stochastic Depth) per sample – timm-free implementation."""
...
class SwinIR(nn.Module):
    r"""SwinIR: Image Restoration Using Swin Transformer (Liang et al., 2021).
